const projects = [
    ...
    },
    {
        id: 27,
        title: {
            en: "Resonance - The ILLUMANATE Living Building Challenge Competition",
            zh: "共振 - ILLUMANATE可持续生活建筑挑战竞赛"
        },
        category: {
            en: "Education & Culture", zh: "文化教育"
        },
    ...
    },
    {
        id: 25,
        title: {
            en: "Boat Auditorium - Shengshan Island Auditorium Competition",
            zh: "渔舟剧场-嵊山岛小剧场竞赛"
        },
        category: [{
            en: "Pavilion & Bridge",
    ...
    },
    {
        id: 12,
        title: {
            en: "Priory Emmaus Maarssen Renovation",
            zh: "乌特勒支修道院改造"
        },
        location: {
    ...
    },
    {
        id: 10,
        title: {
            en: "Growing Toward the Sun, Changing with the Wind - Green Higirise",
            zh: "向阳而生，随风而动 - 绿建高层竞赛"
        },
        location: {
            en: "Nanjing, China",
    ...
    },
    {
        id: 9,
        title: {
            en: "Gecko Suite: Extension of the Body",
            zh: "蜥蜴式套装：身体的延申"
        },
        location: {
            en: "Delft, Netherlands",
    ...
    },
    {
        id: 8,
        title: {
            en: "Shanghai Pudong Software Park Bidding",
            zh: "上海浦东三林软件园投标"
        },
        location: {
            en: "Nanjing, China",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.location.pathname.includes('about.html')) {
        ...
        initializeHoverImages(); // 恢复图片悬浮功能
    ...
    function initializeHoverImages() {
        ...
        const projectImageMap = {
            ...
            'DigitalFUTURES2019 Workshop': 'images/projects/project5/cover.jpg',
            ...
            '数字未来2019工作坊': 'images/projects/project5/cover.jpg',
        };
    ...
    document.addEventListener('keydown', function(e) {
        // 禁用 Ctrl+S, Ctrl+U, Ctrl+Shift+I, F12
        if (
            (e.ctrlKey && e.key === 's') || 
            (e.ctrlKey && e.key === 'u') ||
